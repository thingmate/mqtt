...
export type IReadonlyMqttSubackPacketProperties =
  | IMqttPacketReasonStringProperty
  | IMqttPacketUserProperty
  ;

export type IReadonlyMqttSubackPacketPropertyList = IReadonlyMqttPacketPropertyList<IReadonlyMqttSubackPacketProperties>;

export interface IReadonlyMqttSubackPacketGetPropertiesFunction {
