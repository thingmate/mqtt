...
type IReadonlyMqttPubrelPacketProperties =
  | IMqttPacketReasonStringProperty
  | IMqttPacketUserProperty
  ;

export type IReadonlyMqttPubrelPacketPropertyList = IReadonlyMqttPacketPropertyList<IReadonlyMqttPubrelPacketProperties>;

export interface IReadonlyMqttPubrelPacketGetPropertiesFunction {
