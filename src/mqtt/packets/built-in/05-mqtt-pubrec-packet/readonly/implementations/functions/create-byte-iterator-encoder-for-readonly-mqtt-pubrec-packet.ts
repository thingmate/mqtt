...
import {
  PUBREC_REASON_CODE,
} from '../../../../../components/mqtt-packet-reason/readonly/implementations/built-in/05-pubrec/pubrec-reason-code.enum';
...
export function* createByteIteratorEncoderForReadonlyMqttPubrecPacket(
  {
    getPacketId,
    getReason,
    getProperties,
  ...
  const reasonCode: PUBREC_REASON_CODE = getReason().getCode();
  const properties: IReadonlyMqttPubrecPacketPropertyList = getProperties();
