...
export type IReadonlyMqttPubrecPacketProperties =
  | IMqttPacketReasonStringProperty
  | IMqttPacketUserProperty
  ;

export type IReadonlyMqttPubrecPacketPropertyList = IReadonlyMqttPacketPropertyList<IReadonlyMqttPubrecPacketProperties>;

export interface IReadonlyMqttPubrecPacketGetPropertiesFunction {
