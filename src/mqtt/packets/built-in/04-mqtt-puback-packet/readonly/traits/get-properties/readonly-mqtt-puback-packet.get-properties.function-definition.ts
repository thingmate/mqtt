...
export type IReadonlyMqttPubackPacketProperties =
  | IMqttPacketReasonStringProperty
  | IMqttPacketUserProperty
  ;

export type IReadonlyMqttPubackPacketPropertyList = IReadonlyMqttPacketPropertyList<IReadonlyMqttPubackPacketProperties>;

export interface IReadonlyMqttPubackPacketGetPropertiesFunction {
