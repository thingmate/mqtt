...
} from './get-extra-arguments-function-for-mqtt-packet-byte-iterator-decoder.type';
import { IGetMqttProtocolVersionFunction } from './get-mqtt-protocol-version-function.type';

export function generateGetExtraArgumentsFunctionForMqttPacketByteIteratorDecoder(
  ...
  ) as IGetExtraArgumentsFunctionForMqttPacketByteIteratorDecoder;
}
