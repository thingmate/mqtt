...
const REFACTOR_DIRECTORY_PATH = $path.join(ROOT_PATH, 'src/mqtt/client/minimal/implementations');

const SIMPLE_REFACTOR_FROM = 'mqtt-client';
const SIMPLE_REFACTOR_TO = 'minimal-mqtt-client';
